...
A dark, glassmorphism research portal that indexes **302 primary sources** — official government portals, courts, statutory bodies, international organisations, and peer-reviewed journals — across 11 categories: Government, Education, Economy, Election, Judiciary, Health, International, Reports, Think Tanks, Data, and Research.
...
### Category counts (302 sources total)
...
A note on accuracy: every URL was chosen from well-established, standard official domains (`.gov.in`, `.nic.in`, UN/multilateral agency domains, major peer-reviewed publishers). Government portals do occasionally restructure or rename — it's worth spot-checking links periodically and updating `js/data.js` if any redirect or 404.
